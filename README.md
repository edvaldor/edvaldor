...
- 🧩 Desenvolvimento e manutenção de **sites e portais** (Edronet)  
- 🗞️ Soluções para **conteúdo, comunicação e portais jornalísticos**  
- 🧱 Integrações, automações e melhoria contínua de sistemas  
- 👨‍🏫 Ensino com foco em prática: **projetos, back-end, banco de dados e web**
